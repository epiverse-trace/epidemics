...
#' @param birth_rate A numeric value for the rate of new susceptible individuals entering the population.
#' Default is set to a value that maintains the population constant if equal to the death rate.
#'
#' @param death_rate A numeric value for the rate at which individuals in all compartments die.
#' Default is set based on the estimated overall mortality rate in the population.
#' @details
#'
