...
Run the default epidemic model, using the function `model_default_cpp()`. 
...
From these values we can calculate transmissibility $\beta$ `1.5 / 7.0`, infectiousness_rate $\alpha$ `1.0 / 3.0` and recovery_rate $\gamma$ `1.0 / 7.0`.
