...
[![CRAN status](https://www.r-pkg.org/badges/version/epiverse-trace/epidemics)](https://CRAN.R-project.org/package=epidemics)
<!-- badges: end -->
...
*epidemics* relies on epidemics relies on the [_odin_](https://cran.r-project.org/package=odin) package for defining ODE systems and deSolve for numerical integration, and is developed at the [MRC Centre for Global Infectious Disease Analysis at Imperial College London](https://mrc-ide.github.io/odin/index.html).

## Installation

The current development version of _epidemics_ can be installed from [GitHub](https://github.com/) using the _pak_ package.
...
Contributions to _epidemics_ are welcomed via [pull requests](https://github.com/epiverse-trace/epidemics/pulls).
