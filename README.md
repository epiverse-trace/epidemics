...
# epidemics: Model epidemics

<!-- <img src="man/figures/logo.png" align="right" width="130"/> -->

*epidemics* is intended to provide functions to model epidemic
outbreaks. This package is still a work in progress, and most functions
are placeholders.
...
You can install the development version of *epidemics* from
