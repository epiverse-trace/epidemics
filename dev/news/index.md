...
1.  The `<intervention>` helper functions
    [`.cumulative_rate_intervention()`](https://epiverse-trace.github.io/epidemics/dev/reference/cumulative_rate_intervention.md)
    and
...
1.  [`.check_prepare_args_ebola()`](https://epiverse-trace.github.io/epidemics/dev/reference/prepare_ebola_args.md)
    is a new argument cross-checking and preparation function for the
    Ebola model
    ([\#212](https://github.com/epiverse-trace/epidemics/issues/212)).

2.  [`epidemic_size()`](https://epiverse-trace.github.io/epidemics/dev/reference/epidemic_size.md)
...
3.  Added function
    [`.output_to_df_ebola()`](https://epiverse-trace.github.io/epidemics/dev/reference/output_to_df.md)
...
2.  The new internal functions
    [`.prepare_population()`](https://epiverse-trace.github.io/epidemics/dev/reference/dot-prepare_population.md),
    [`.cross_check_intervention()`](https://epiverse-trace.github.io/epidemics/dev/reference/cross_checking_inputs.md),
    [`.cross_check_vaccination()`](https://epiverse-trace.github.io/epidemics/dev/reference/cross_checking_inputs.md),
    [`.cross_check_timedep()`](https://epiverse-trace.github.io/epidemics/dev/reference/cross_checking_inputs.md),
    and
    [`.cross_check_popchange()`](https://epiverse-trace.github.io/epidemics/dev/reference/cross_checking_inputs.md)
...
4.  [`output_to_df()`](https://epiverse-trace.github.io/epidemics/dev/reference/output_to_df.md)
    is renamed to
    [`.output_to_df()`](https://epiverse-trace.github.io/epidemics/dev/reference/output_to_df.md).
