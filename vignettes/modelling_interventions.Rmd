...
_epidemics_ reconciles the two conventions for you: the model functions transpose the contact matrix internally.
Matrices from _socialmixr_ can therefore be passed to `population()` exactly as they are returned, with no call to `t()`.
:::
