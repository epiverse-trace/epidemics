...
epidemic_size_estimates <- select(output, param_set, data) %>%
  mutate(
    size = map_dbl(data, epidemic_size, by_group = FALSE)
  ) %>%
  select(-data)
```
