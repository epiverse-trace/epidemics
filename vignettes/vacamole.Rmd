---
title: "Using the RIVM Vacamole model of leaky vaccination and hospitalisations"
output:
...
link-citations: true
vignette: >
  %\VignetteIndexEntry{Using the RIVM Vacamole model of leaky vaccination and hospitalisations}
...
double_vaccination <- vaccination(
  ...
  # first doses begin after approx. 100 days
  # second doses begin 1 month after first doses
  time_begin = matrix(
    c(30, 60),
    nrow = 3, ncol = 2,
    byrow = TRUE
  ),
  # doses are given until the end of the simulation
  time_end = matrix(
    epidemic_days,
    nrow = 3, ncol = 2
  )
